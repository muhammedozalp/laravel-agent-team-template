                ...
                <div className="flex w-full items-center justify-center lg:grow">
                    <main className="flex w-full max-w-[335px] flex-col-reverse lg:max-w-4xl lg:flex-row">
                                ...
                                <li className="relative flex items-center gap-4 py-2 before:absolute before:top-1/2 before:bottom-0 before:left-[0.4rem] before:border-l before:border-[#e3e3e0] dark:before:border-[#3E3E3A]">
                                    ...
                                    <span>
                                        ...
                                        <a
                                            ...
                                            target="_blank"
                                            className="ml-1 inline-flex items-center space-x-1 font-medium text-[#e02d00] underline underline-offset-4 dark:text-[#FF4433]"
                                        >
                        ...
                        <div className="relative -mb-px aspect-[335/364] w-full shrink-0 overflow-hidden rounded-t-lg bg-[#fff2f2] lg:mb-0 lg:-ml-px lg:aspect-auto lg:w-[438px] lg:rounded-t-none lg:rounded-r-lg dark:bg-[#1D0002]">
                            {/* Laravel Logo */}
                            <svg
                                className="w-full max-w-none translate-y-0 text-[#E02D00] opacity-100 transition-all dark:text-[#F61500] motion-safe:starting:translate-y-6"
                                viewBox="0 0 438 104"
                                fill="none"
                                xmlns="http://www.w3.org/2000/svg"
                            >
                            ...
                            <svg
                                ...
                                xmlns="http://www.w3.org/2000/svg"
                            >
                                <g className="text-[#1B1B18] opacity-100 mix-blend-darken transition-all delay-300 dark:text-black dark:mix-blend-normal">
                                    <mask
                                        id="path-1-mask"
                                ...
                                <g className="text-[#F3BEC7] opacity-100 transition-all delay-400 dark:text-[#4B0600] motion-safe:starting:-translate-x-[26px]">
                                    <mask
                                        id="path-2-mask"
                                        maskUnits="userSpaceOnUse"
                                        x="25.3357"
                                ...
                                <g className="text-[#F8B803] opacity-100 mix-blend-color transition-all delay-400 dark:text-[#391800] dark:mix-blend-hard-light motion-safe:starting:-translate-x-[51px]">
                                    <mask
                                        id="path-3-mask"
                                        maskUnits="userSpaceOnUse"
                                        x="51"
                                ...
                                <g className="text-[#F3BEC7] opacity-100 mix-blend-multiply transition-all delay-400 dark:text-[#733000] dark:mix-blend-normal motion-safe:starting:-translate-x-[78px]">
                                    <mask
                                        id="path-4-mask"
                                        maskUnits="userSpaceOnUse"
                                        x="76.6643"
                                ...
                                <g className="text-[#F3BEC7] opacity-100 mix-blend-hard-light transition-all delay-400 dark:text-[#4B0600] motion-safe:starting:-translate-x-[102px]">
                                    <mask
                                        id="path-5-mask"
                                        maskUnits="userSpaceOnUse"
                                        x="102.329"
